<<<<<<< HEAD
# Analisi PHPStan Livello 1 - Modulo Gdpr
...
- Il modulo gestisce correttamente le funzionalità GDPR senza problemi di tipo
...
- Rispettare le normative GDPR nella gestione dei dati 
=======
...
>>>>>>> aurmich/dev
>>>>>>> aurmich/dev
# Rapporto PHPStan Livello 1 per il modulo Gdpr
