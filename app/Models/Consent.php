 ...
 * @method static Consent|null first()
 * @method static \Illuminate\Database\Eloquent\Collection<int, Consent> get()
 * @method static Consent create(array $attributes = [])
 * @method static Consent firstOrCreate(array $attributes = [], array $values = [])
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Consent where(string|\Closure $column, mixed $operator = null, mixed $value = null, string $boolean = 'and')
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Consent whereNotNull(string|\Illuminate\Contracts\Database\Query\Expression $columns)
