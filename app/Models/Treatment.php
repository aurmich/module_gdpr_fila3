 ...
 *
 * @method static Treatment|null first()
 * @method static \Illuminate\Database\Eloquent\Collection<int, Treatment> get()
 * @method static Treatment create(array $attributes = [])
 * @method static Treatment firstOrCreate(array $attributes = [], array $values = [])
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Treatment where(string|\Closure $column, mixed $operator = null, mixed $value = null, string $boolean = 'and')
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Treatment whereNotNull(string|\Illuminate\Contracts\Database\Query\Expression $columns)
