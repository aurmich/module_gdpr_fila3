 ...
 *
 * @method static Event|null first()
 * @method static \Illuminate\Database\Eloquent\Collection<int, Event> get()
 * @method static Event create(array $attributes = [])
 * @method static Event firstOrCreate(array $attributes = [], array $values = [])
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Event where(string|\Closure $column, mixed $operator = null, mixed $value = null, string $boolean = 'and')
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Event whereNotNull(string|\Illuminate\Contracts\Database\Query\Expression $columns)
